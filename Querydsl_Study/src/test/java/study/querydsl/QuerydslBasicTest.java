...
public class QuerydslBasicTest {
    ...
    @Test
    public void fetchJoinNormalJoinUse() throws Exception {
        em.flush();
        em.clear();
        Member findMember = queryFactory
                .selectFrom(member)
        ...
        boolean loaded =
                emf.getPersistenceUnitUtil().isLoaded(findMember.getTeam());
        assertThat(loaded).as("일반 조인 적용").isFalse();
    }
    ...
    public void constant() {
        Tuple result = queryFactory  //sql문으로는 안날라감
    ...
    @Test
    public void findDtoByFieldMissMatching() {
        QMember memberSub = new QMember("memberSub");
    ...
    @Test
    public void findDtoByConstructorMissMatching() {
    ...
    private List<Member> searchMember2(String usernameCond, Integer ageCond) {
        return queryFactory
                .selectFrom(member)
                .where(allEq(usernameCond, ageCond))  // BooleanBuilder 보다 깔끔함
                .fetch();
    }
